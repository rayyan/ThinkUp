...
{/foreach}</ul></li>
  ...
  <div class="thinkup-canvas round-all container_24">
    ...
    <br /><br />
            ...
            {if $next_page}
                <a href="{$site_root_path}beta.php?{if $smarty.get.v}v={$smarty.get.v}&{/if}{if $smarty.get.u}u={$smarty.get.u}&{/if}{if $smarty.get.n}n={$smarty.get.n}&{/if}page={$next_page}" id="next_page">Next Page &#62;</a>
            {/if}
            </div>
{else}
